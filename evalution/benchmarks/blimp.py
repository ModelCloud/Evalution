...
class BLiMP(BaseMultipleChoiceSuite):
    ...
    def build_sample(self, doc: dict[str, Any], *, index: int) -> MultipleChoiceSample:
        return MultipleChoiceSample(
            ...
            prompt="",
            choices=[
                str(doc["sentence_good"]),
                str(doc["sentence_bad"]),
            ],
            gold_index=0,
            metadata={
                "subset": self.subset,
                "field": str(doc["field"]),
                "linguistics_term": str(doc["linguistics_term"]),
                "uid": str(doc["UID"]),
                "simple_lm_method": bool(doc["simple_LM_method"]),
                "one_prefix_method": bool(doc["one_prefix_method"]),
                "two_prefix_method": bool(doc["two_prefix_method"]),
                "lexically_identical": bool(doc["lexically_identical"]),
                "pair_id": int(doc["pair_id"]),
            },
        )
