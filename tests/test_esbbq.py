...
def test_esbbq_scores_three_way_bias_question(monkeypatch) -> None:
    """Verify esbbq scores three way bias question. Keep the scoring path explicit so benchmark-specific behavior stays auditable."""
...
def test_esbbq_rejects_unknown_category() -> None:
    """Verify esbbq rejects unknown category."""
