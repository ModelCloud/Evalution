...
def test_wic_scores_word_in_context_accuracy(monkeypatch) -> None:
    """Verify wic scores word in context accuracy. Keep the scoring path explicit so benchmark-specific behavior stays auditable."""
...
def test_wic_helpers_extract_target_word_and_prompt() -> None:
    """Verify wic helpers extract target word and prompt."""
    doc = {
