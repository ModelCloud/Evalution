...
def test_lambada_cloze_scores_single_continuation_loglikelihood(
    ...
    """Verify lambada cloze scores single continuation loglikelihood. Keep the scoring path explicit so benchmark-specific behavior stays auditable."""
...
def test_lambada_cloze_marks_non_greedy_continuation_incorrect(monkeypatch) -> None:
    """Verify lambada cloze marks non greedy continuation incorrect."""
