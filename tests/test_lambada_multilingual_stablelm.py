...
def test_lambada_multilingual_stablelm_scores_single_continuation_loglikelihood(
    ...
    """Verify lambada multilingual stablelm scores single continuation loglikelihood. Keep the scoring path explicit so benchmark-specific behavior stays auditable."""
